...
\todo[inline]{Add symbols to Fig. 1 overview and reference the Figure again here?  I note below we intend to also indicate those observed spectroscopically with a separate symbol or different color.  Could be tricky. WPB}
