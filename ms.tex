...
Figure \ref{fig.galaxy} shows all the objects from the {\bf [Need to revise this, make a figure, and get correct numbers]} B12, D10, and B14 catalogs, and highlights those for which we obtained spectra (red boxes).  %, and Table \ref{obs_log} lists all the SNR candidates for which we obtained spectra.
...
This is a citation to \cite{long14}0
