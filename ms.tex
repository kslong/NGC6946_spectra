...
We identified 147 candidate SNRs from the WYIN interference images; of these we obtained spectra of 102. The spectra were needed to improve our confidence that the [SII]:\ha\ ratios of the emission nebulae were indeed high and to begin to characterize the SNRs.  The spectroscopic ratios are shown as a function of galactocentric radius in the left panel of  Fig.\ \ref{fig_s2_ha}.  Conventionally, emission nebulae are identified as SNRs optically, if the [SII]:\ha\ ratio exceeds 0.4; 89 of the 102 SNRs with spectra satisfy this criterion, and so we regard these as confirmed SNRs (and they have been listed as such in Table \ref{table_candidates}. Clearly, even though a dividing line of 0.4 is somewhat arbitrary, the other objects should be judged we more suspicion.  The tendency to see higher SII]:\ha\ ratios closer to the nucleus is most likely at least partly an abundance effect; similar trends are seen in M33 \citep{long18} and in M83 \citep{winkler17}. 

There are 45 objects without a spectra, so which of these are actually SNRs is uncertain.  That said, as shown in the right panel of Fig.\ \ref{fig_s2_ha} the spectroscopically determined ratio tend to be if anything higher than the ratio determined from narrow band imaging, and so most of the objects without spectra are likely to be good optical SNRs.  That the spectroscopic ratios tend to be higher than the imaging ratios is expected, since the \ha\ filter also passes some emission from [N II].   

Of the 27 SNR candidates identified by MF97, all have imaging [SII]:\ha\ ratios that exceed 0.4. MF97 obtained spectra of six of their candidates.  We have obtained spectra of 23 of the MF97 objects, including new spectra of the 5 objects for which MF97 had spectra. Four -- MF003, MF021, MF022, and MF026 -- were observed spectroscopically.  All of these have measured spectroscopic ratios exceed 0.4.
\todo[inline]{We need a more complete discussion of MF97 and our results.  Possibly this is something wpb could do}



\hb:\ha\ ratios of the SNR candidates with spectra are shown in Fig.\ \ref{fig_reddening} as a function of galacto centric distance. Nearly all of the the SNRs show significant reddening, as one would expect since at 12\degr\ from the Galactic plane, reddening from within the Galaxy along the line of sight to be E(B-V) of 0.29 \citep{schlafly11}.  There is clearly substantial internal reddening as well, and a very evident trend for objects near the center of NGC6946 being more reddened than those that are more distant from the nucleus.
...
\begin{enumerate}
    ...
    \item \sii:\ha\ ratio vs \ha\ flux; \sii:\ha\ ratio vs GC distance (fig for this already here)  Check M83 to see if there is a correlation in the spectroscopic ratio with GC, and if so comment on this.  This is done for S2; I guess we could to it for N2
    \item We don't give any diameter values for objects.  WIYN data are not great for this, but may be worth something.  Also, aren't there WFC3 Pa$\beta$(?) images; are these useful for getting diameters? There are also a handful of \ha\ images (from ACS or WFC2) which should be useful.  If we are to use these, we need to add another short subsection under Observations.  We do not have diameters, so I don't think we can do this 00 ksl
