...
We identified 147 candidate SNRs from the WYIN interference images; of these we obtained spectra of 102. The spectra were needed to improve our confidence that the [SII]:\ha\ ratios of the emission nebulae were indeed high and to begin to characterize the SNRs.  The spectroscopic ratios are shown as a function of galactocentric radious in Fig.\ \ref{fig_s2_ha}.  Conventionally, emission nebulae are identified as SNRs optically, if the [SII]:\ha\ ratio exceeds 0.4; 89 of the 102 SNRs with spectra satisfy this criterion, and so we regard these as confirmed SNRs (and they have been listed as such in Table \ref{table_candidates}. Clearly, even though a dividing line of 0.4 is somewhat arbitrary, the other objects should be judged we more suspicion. There are 45 objects without a spectra, so which of these are actually SNRs is uncertain.

\todo[inline]{Find out how many of the MF objects are confirmed.  Make a plote of the imaging and spectroscopic ratios}
...
\begin{enumerate}
    ...
    \item \sii:\ha\ ratio vs \ha\ flux; \sii:\ha\ ratio vs GC distance (fig for this already here)  Check M83 to see if there is a correlation in the spectroscopic ratio with GC, and if so comment on this
