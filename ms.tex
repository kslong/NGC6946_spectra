...
The SNR candidates are listed in Table \ref{table_candidates}.

\todo[inline]{Why is ref for this table not picked up?  We need to describe the table in the text here.}
...
\todo[inline]{The table needs to be described.  Tables 3 \& 4 need to be modified with longtable, or something, so they will carry over to multiple pages.}
