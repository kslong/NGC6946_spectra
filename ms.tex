...
\todo[inline]{We need a more complete discussion of MF97 and our results.  Possibly this is something wpb could do.  WPB: possibly, if it can wait until I return.  The above paragraph says both "4" and "5" MF objects were observed spectroscopically, so this needs to get cleaned up.}

\todo[inline]{Add comparison here to X-ray sources and to radio SNRs from earlier Lacey paper and also Bruursema+ (2014)}

As shown in Fig.\ \ref{fig_s2_ratio}, the ratios of [SII]$\lambda$6717:SII]$\lambda$6731 for the SNR candidates cluster around the low density limit of 1.4, and from the fact that just about as many objects have nonphysical ratios above 1.4 as below, suggests that the all of the objects are close to this limit.  In the absence of SNR dieameters, we cannot search for trends with diameter, as were seen in M33 (L18) and M83 \citep{winkler17}. 
